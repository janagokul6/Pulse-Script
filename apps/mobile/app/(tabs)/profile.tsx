      ...
      <ScrollView showsVerticalScrollIndicator={false} stickyHeaderIndices={[2]}>
        ...
        <RNView style={[styles.heroSection, { backgroundColor: theme.background, borderBottomColor: theme.border }]}>
          ...
          <RNView style={styles.nameHeader}>
            <Text style={[styles.profileName, { color: theme.text }]}>{user?.name || 'Dr. Alistair Thorne'}</Text>
            <Text style={[styles.profileTitle, { color: theme.tint }]}>{user?.specialization || 'Chief of Cardiovascular Surgery | MD, FRCS'}</Text>
            <Text style={[styles.profileCredentials, { color: theme.secondary }]}>{user?.bio || 'Royal Academy of Medicine • 22 years clinical expertise'}</Text>
          </RNView>
          ...
          <RNView style={styles.heroActions}>
            ...
            <TouchableOpacity style={[styles.btnFollow, { backgroundColor: theme.tint }]}>
