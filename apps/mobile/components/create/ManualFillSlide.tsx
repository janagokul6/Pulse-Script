/**
 * ManualFillSlide — Exact structured edit form UI from edit.tsx,
 * wrapped as an embeddable slide component for the carousel.
 * All styling, layout, and colors are 100% preserved.
 * Initializes with an empty draft (no searchParams dependency).
 */
...
export default function ManualFillSlide({ theme }: { theme: Theme }) {
